...
**AI代码生成工具对比** — 聚合 AI coding assistant 的定价、功能、评分等公开数据，做中立对比站。
...
### 来源
- **评分**: 第6轮实地调研修正评分 **47.5分**
- **搜索量**: pytrends 查询 `AI coding assistant` 平均搜索量数据
- **竞品**: Chrome扩展3层搜索法确认无程序化对比站竞品
- **详细报告**: C:\Users\Administrator\Desktop\调研讨论\结构化网站方向选取\07_第六轮_实地调研修正评分.md

### 代表工具
GitHub Copilot / Cursor / Codeium / Tabnine / Amazon Q

### 核心对比维度
定价方案/支持IDE/编程语言数/上下文窗口/补全速度/聊天功能/私有部署
